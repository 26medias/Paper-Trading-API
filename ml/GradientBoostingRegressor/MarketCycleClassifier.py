...
class MarketCycleClassifier:
    def __init__(self, data_dir=None, model_dir=None, test_size=0.2, val_size=0.1, random_state=42, n_estimators=100, learning_rate=0.1, max_depth=3, model="up"):
    ...
    def save_model(self):
        ...
        model_path = os.path.join(self.model_dir, f"gradient_boosting_model_{self.modelName}.joblib")
    ...
    def export_model_to_js(self):
        ...
        with open(os.path.join(self.model_dir, f"gradient_boosting_model_{self.modelName}.js"), 'w') as f:
            f.write(model_code)
